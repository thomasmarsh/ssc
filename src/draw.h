...
namespace draw
{
        ...
        {
                if (transY) y1=Screen::mDisplay.y-y1, y2=Screen::mDisplay.y-y2;
                glBegin(GL_LINES);
                  glVertex2i(x1, y1+extra); glVertex2i(x1, y2-extra);
                  glVertex2i(x1-extra, y2); glVertex2i(x2+extra, y2);
                  glVertex2i(x2, y2-extra); glVertex2i(x2, y1+extra);
                  glVertex2i(x1-extra, y1); glVertex2i(x2+extra, y1);
                glEnd();
        }
