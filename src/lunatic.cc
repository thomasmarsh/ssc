...
void pprint(Speed s)
{
        switch (s)
        {
        case S_POS_FAST: FLOG("S_POS_FAST"); break;
        case S_POS_SLOW: FLOG("S_POS_SLOW"); break;
        case S_ZERO:     FLOG("S_ZERO"); break;
        case S_NEG_SLOW: FLOG("S_NEG_SLOW"); break;
        case S_NEG_FAST: FLOG("S_NEG_FAST"); break;
        case S_LAST:     FLOG("S_LAST"); break;
        }
}
...
void pprint(Angle s)
{
        switch (s)
        {
        case A_POS_LARGE: FLOG("A_POS_LARGE");  break;
        case A_POS_SMALL: FLOG("A_POS_SMALL"); break;
        case A_ZERO:      FLOG("A_ZERO"); break;
        case A_NEG_SMALL: FLOG("A_NEG_SMALL"); break;
        case A_NEG_LARGE: FLOG("A_NEG_LARGE"); break;
        case A_LAST:      FLOG("A_LAST"); break;
        }
}
...
void pprint(Power p)
{
        switch (p)
        {
        case P_POS_HI:  FLOG("P_POS_HI"); break;
        case P_POS_LOW: FLOG("P_POS_LOW"); break;
        case P_ZERO:    FLOG("P_ZERO"); break;
        case P_NEG_LOW: FLOG("P_NEG_LOW"); break;
        case P_NEG_HI:  FLOG("P_NEG_HI"); break;
        case P_LAST:    FLOG("P_LAST"); break;
        }
}
...
double PowerPeak(Power p)
{
        switch (p)
        {
        case P_POS_HI:  return 0;
        case P_POS_LOW: return .25;
        case P_ZERO:    return .50;
        case P_NEG_LOW: return .75;
        case P_NEG_HI:  return 1;
        default: break;
        }
        return 0;
}
...
inline
double membership(double tri[], double value)
{
        if (value == tri[1]) return 1;
        if (value < tri[0]) return 0;
        if (value > tri[2]) return 0;
...
{
        // normalize angle
        while (angle < 0) angle += D_PI;
        while (angle > D_PI) angle -= D_PI;
...
//      FLOG("--------------------\n\n");
        ...
        for (int i = 0; i < P_LAST; i++) squares[i] = 0;
